...
const Capons = () => {
    ...
    return (
        <div className='mb-10 max-w-7xl mx-auto'>
            <div style={{ background: 'linear-gradient(90deg, #f9d423 0%, #ff4e50 100%)', padding: '2rem', borderRadius: '16px', boxShadow: '0 4px 24px rgba(0,0,0,0.08)', margin: '0 1rem 3rem 1rem' }}>
