        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-100 my-5">
            ...
            <div className="bg-gradient-to-br from-blue-500 to-purple-600 text-white py-8 px-5 text-center relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto">
                    <h1 className="text-4xl md:text-5xl font-bold mb-5 text-shadow-lg">About Our Club</h1>
            ...
            <div className="max-w-7xl mx-auto px-5 py-15">
                ...
                <section className="mb-15 bg-white rounded-3xl p-12 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
                        <div className="bg-gray-50 p-8 rounded-2xl text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-lg border-2 border-transparent hover:border-blue-500">
                            <div className="text-5xl mb-5">🏆</div>
                ...
                <section className="mb-15 bg-white rounded-3xl p-12 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-8">
                        <div className="bg-white p-8 rounded-3xl text-center shadow-lg transition-all duration-300 hover:-translate-y-2">
